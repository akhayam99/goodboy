...
palette) or straight on GitHub. The in-app form only sends what you type:
version, area, title and notes, nothing else. It doesn't take screenshots
yet, drag one onto the issue once it opens on GitHub. Half-formed thoughts
welcome. "This feels off" is a perfectly valid bug report.
