...
export const SESSION_EVICTION = [
  ...
  { key: 'artifactDrafts', keyedBy: 'session', evictOn: 'delete' },
  ...
  { key: 'stepSummaryDegraded', keyedBy: 'agent', evictOn: 'delete' },
  { key: 'degradedStepOutputs', keyedBy: 'agent', evictOn: 'delete' },
  { key: 'scoutSelfExploreTasked', keyedBy: 'agent', evictOn: 'delete' },
...
export const NON_SESSION_STATE_KEYS = [
  ...
  'updateProgress',
  'updateCheckedAt',
  'updateQueuedUntilIdle',
  'changelogReleases',
  'changelogDates',
  'changelogDatesStatus',
  'changelogDatesFetchedAt',
