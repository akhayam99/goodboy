...
export type AppState = UpdaterState & {
  ...
  readonly workspaceIntegrations: Readonly<Record<WorkspaceId, ReadonlyArray<WorkspaceIntegration>>>
  ...
  readonly sessionPanelExpanded: Readonly<Record<SessionId, Partial<Record<PanelSection, boolean>>>>
...
export type AppActions = {
  ...
  updatePlanBody(sessionId: SessionId, planId: PlanId, title: string, bodyMd: string): Promise<void>
