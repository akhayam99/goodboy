...
const CONTEXT_MARKER_HINT =
  ...
  'when you have an open question that the user must answer before continuing, wrap it as `<<ctx-question>>your question<</ctx-question>>`. when the question is a bounded choice, offer 2 to 4 concrete options the user can pick in one tap via the `suggestions` attribute, pipe-separated: `<<ctx-question suggestions="option a | option b | option c">>your question<</ctx-question>>`.\n' +
