...
export const SessionsSection = ({}: Props) => (
  <div className="flex flex-col gap-7">
    <SectionHeader
      ...
      label="Sessions"
      hint="One focused unit of work. Creates a worktree for each project, with a branch, transcripts, and a goal. It is a card on the board until you open it."
    />
    ...
    <Block title="What gets created">
      <DefinitionList
        rows={[
          {
            term: 'worktree',
            desc: 'A separate working directory created per project in the session.',
