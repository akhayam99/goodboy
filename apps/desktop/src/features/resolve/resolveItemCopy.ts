...
export const RESOLVE_ITEM_LABEL = {
  ...
  aboutThisComment: 'About this comment',
  change: 'Changes',
  checks: 'Checks',
  reply: 'Reply',
  ...
  discussionReply: 'Reply to the reviewer',
  discussionNote: 'Posted as soon as you send it, the comment stays open',
  resolve: 'Resolve',
  ...
  nothingToApprove: 'No fix and no reply to send yet',
