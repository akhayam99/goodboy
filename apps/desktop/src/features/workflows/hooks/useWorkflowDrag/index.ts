...
type Drag = { kind: 'step'; fromIndex: number; label: string };
...
export const useWorkflowDrag = ({ enabled, onReorder }: Params) => {
  ...
  return { drag, dragPos, dropIndex, setDropIndex, startStepDrag, ghost };
};
