...
export const DestinationRow = ({
  ...
  return (
    <button
      ...
      className={cn(
        'flex w-full min-w-0 items-center gap-2 rounded-md px-2 py-1.5 text-left text-label transition-colors',
        isCurrent
    ...
    >
      ...
      {glyphs === '' ? null : (
        <span className="shrink-0 text-secondary tracking-wide text-faint-foreground">
          {glyphs}
        </span>
      )}
    </button>
