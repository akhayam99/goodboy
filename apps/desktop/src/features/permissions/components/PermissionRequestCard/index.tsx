  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-2">
        ...
        <span className="rounded-md bg-elevated px-1.5 py-0.5 text-secondary font-medium uppercase tracking-eyebrow text-muted-foreground">
          approval needed
        </span>
      ...
      {inputPreview !== null && (
        <ClampedProse
          text={inputPreview}
          lines={4}
          className="min-w-0 break-words rounded-md bg-elevated px-2 py-1 font-mono text-secondary text-muted-foreground"
        />
      )}
      {showPicker ? (
