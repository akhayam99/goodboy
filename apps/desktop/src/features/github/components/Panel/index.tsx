...
import { Button, cn, formatError, Input, Tooltip, tintClasses } from '@goodboy/ui';
      ...
      <div className="flex items-center gap-2">
        ...
        <Tooltip content="Refresh GitHub status" anchorClassName="shrink-0">
          <button
            ...
            className="flex size-7 shrink-0 items-center justify-center rounded-md text-muted-foreground ring-1 ring-border-soft transition-colors hover:bg-hover hover:text-foreground disabled:opacity-50"
          >
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className={cn(tintClasses('warning').text)}>
            install from{' '}
            <a
      ...
      >
        <div className="flex items-start gap-2">
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <span className={cn(tintClasses('success').text)}>
              mode: {status.mode}
