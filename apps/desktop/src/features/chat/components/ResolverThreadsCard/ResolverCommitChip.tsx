...
const CHIP_CLASS =
  'inline-flex shrink-0 items-center gap-1 rounded-md border border-border-soft px-1.5 py-0.5 font-mono text-secondary tabular-nums text-muted-foreground';
