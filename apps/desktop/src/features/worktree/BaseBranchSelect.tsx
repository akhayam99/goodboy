    ...
    <AnchoredPopover
      ...
      trigger={
        <button
          ...
          className={cn(
            'flex h-7 min-w-0 items-center gap-1 rounded-md border border-border bg-background px-2 text-code text-foreground hover:border-border-strong hover:bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring disabled:cursor-not-allowed disabled:opacity-50',
