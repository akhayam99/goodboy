...
const PILL =
  'inline-flex items-center gap-1 rounded-full border border-border-soft px-1.5 py-0.5 text-secondary text-muted-foreground motion-safe:transition-colors hover:border-border hover:bg-hover hover:text-foreground disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring';
