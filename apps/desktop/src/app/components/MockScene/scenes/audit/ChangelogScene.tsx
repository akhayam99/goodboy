...
const clock = sceneClock({ anchor: '2026-09-22T18:00:00.000Z' });
...
const RELEASES = [
  {
    version: 'v0.3.14',
    publishedAt: clock.iso({ at: '2026-09-22T18:00:00.000Z' }),
  ...
  {
    version: 'v0.3.13',
    publishedAt: clock.iso({ at: '2026-09-20T18:00:00.000Z' }),
  ...
  {
    version: 'v0.3.12',
    publishedAt: clock.iso({ at: '2026-09-17T18:00:00.000Z' }),
    body: '',
