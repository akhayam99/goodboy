...
mod rewrite_tests {
    use super::{
        remove_worktree_checked_with, worktree_amend_commit_blocking, worktree_branch_holder_blocking,
        worktree_change_branch_blocking, worktree_create_blocking, worktree_squash_commits_blocking,
        worktree_status_blocking, ChangeBranchArgs, CreateArgs, GitDistance, GitUnknownReason,
        GitWorkingTree, RewriteArgs,
    };
    use std::path::{Path, PathBuf};
