...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workflows::capability_obligations_for_session,
            workflows::capability_need_record,
            workflows::capability_grants_for_session,
            ...
            workflows::cluster_graph_freeze,
            workflows::cluster_graph_revision_adopt,
            workflows::cluster_graph_revision_refuse,
