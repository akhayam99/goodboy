...
const LEGACY_SELECTIONS: Readonly<Record<string, ModelSelection>> = {
  ...
  'codex:gpt-5.6': { key: 'gpt-5.6-sol' },
  'codex:gpt-5.5': { key: 'gpt-5.5' },
  'codex:gpt-5.4': { key: 'gpt-5.6-terra' },
  'codex:gpt-5.2': { key: 'gpt-5.6-terra' },
  'codex:gpt-5.3-codex': { key: 'gpt-5.6-terra' },
  'codex:gpt-5.3-codex-spark': { key: 'gpt-5.6-luna' },
  'codex:gpt-5.4-mini': { key: 'gpt-5.6-luna' },
  ...
  'opencode:opencode/minimax-m2.5-free': { key: 'big-pickle' },
  'opencode:opencode/nemotron-3-super-free': { key: 'big-pickle' },
  'opencode:opencode/ring-2.6-1t-free': { key: 'big-pickle' },
  'opencode:minimax-m2.5': { key: 'big-pickle' },
  'opencode:nemotron-3-super': { key: 'big-pickle' },
  'opencode:ring-2.6-1t': { key: 'big-pickle' },
