...
export type { DetailPageProps, DetailSection } from './components/DetailPage';
...
export type { ConfirmRole, InlineConfirmProps } from './components/InlineConfirm';
...
export type { MetaGridProps, MetaItem } from './components/MetaGrid';
