...
| `--z-index-popover-backdrop` | 55    | `z-popover-backdrop`      | click-catcher behind the five app-global popovers below                                                                                                                |
| `--z-index-popover`          | 65    | `z-popover`               | `NotificationCenter`, `WorkspaceSwitcher`, `RunningScriptsIndicator`, `AppTopBar/NeedsYouPopover`, `AppFooter/IntegrationAddPopover`                                   |
